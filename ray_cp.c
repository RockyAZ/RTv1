...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/18 19:25:48 by azaporoz          #+#    #+#             */
/*   Updated: 2018/09/18 19:25:49 by azaporoz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	trace_ray(t_vec camera, t_vec diraction, t_col *color)
{
	...
	t_sphere	spheres[3] = 
	{
		...
		{{2, 0, 4}, 3, {0, 0, 255, 255}}, // blue
		{{-2, 0, 4}, 4, {0, 255, 0, 255}}, // green
	};
...
void	draw_sphere(t_env env)
{
	...
	while (++xy.x < WINDOW_W / 2)
	{
		...
		while (++xy.y < WINDOW_H / 2)
		{
			...
			// printf("%f\n%f\n%f\n", diraction.x, diraction.y, diraction.z);
